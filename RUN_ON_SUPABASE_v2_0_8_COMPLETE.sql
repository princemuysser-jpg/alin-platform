-- منصة آلين v2.0.8 — تحديث Supabase المعتمد والقابل لإعادة التشغيل
...
-- ملاحظة: الأوامر التالية مضافة في v2.0.8 لتنظيف كلمات المرور القديمة وتأمين المندوبين.
...
-- ============================================================
-- v2.0.8: إنشاء الطلبات من الخادم بدلاً من الكتابة المباشرة
-- ============================================================
begin;
...
-- ============================================================
-- v2.0.8: حماية الجداول الحساسة وسياسات RLS الموحدة
-- ============================================================
begin;
