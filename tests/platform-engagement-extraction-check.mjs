...
for(const [name,html] of [['desktop',desktop],['mobile',mobile]]){
  check((html.match(/\.\/store\/banners\.js\?v=2\.3\.1/g)||[]).length===1,`${name} banner loaded once`);
  check((html.match(/\.\/modules\/core\/notifications\.js\?v=2\.3\.1/g)||[]).length===1,`${name} service loaded once`);
