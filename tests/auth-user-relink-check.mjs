...
const client=fs.readFileSync(new URL('../modules/core/account-admin-service.js',import.meta.url),'utf8');
const sql=fs.readFileSync(new URL('../RUN_ON_SUPABASE_v2_1_8_COMPLETE.sql',import.meta.url),'utf8');
