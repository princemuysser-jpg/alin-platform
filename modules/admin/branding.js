// === admin/branding.js ===
/* ALIN v2.3.1 — authoritative visual identity owner. No function wrapping. */
(function(){
  'use strict';
  ...
  function render(root=document.getElementById('adminContent')){
    ...
    root.innerHTML=`<header class="ab176-head"><div><h2>الهوية البصرية</h2><p>شعار وألوان وخطوط موحدة لكل صفحات منصة آلين.</p></div><span>v2.3.1</span></header><div class="ab176-layout"><main>
