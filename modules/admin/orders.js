...
(function(){
  ...
  const moneyText=v=>typeof window.money==='function'?window.money(v):Number(v||0).toLocaleString('ar-IQ');
  ...
  function dateText(o){const d=orderDate(o);return d.getTime()?d.toLocaleString('ar-IQ'):'—'}
