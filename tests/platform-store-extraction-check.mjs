...
for (const [name, html] of [['desktop', desktop], ['mobile', mobile]]) {
  check(html.includes('./modules/store/discovery.js?v=2.3.3'), `${name}-discovery-version`);
  check(html.indexOf('./modules/core/platform.js?v=2.3.3') < html.indexOf('./modules/store/discovery.js?v=2.3.3'), `${name}-load-order`);
