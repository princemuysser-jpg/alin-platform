...
if(!library.includes("c.rpc('alin_library_set_order_status'")&&!library.includes("cancellation_reason:text"))throw new Error('Library runtime must use the workflow RPC or write cancellation_reason');
