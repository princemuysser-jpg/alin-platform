...
(function(){
  ...
  const en={
    ...
    'الإعدادات':'Settings','الإعدادات العامة':'General settings','عام':'General','التواصل':'Contact','تواصل معنا':'Contact us','عن المنصة':'About the platform','عن منصة آلين':'About Alin','الهوية البصرية':'Brand identity','اللون الأساسي':'Primary color','اللون الثانوي':'Secondary color','الشعار':'Logo','الأيقونة':'Icon','الخلفية':'Background','اللغة':'Language','المظهر':'Appearance','نهاري':'Light','ليلي':'Dark','النظام':'System','الخيارات':'Options','التفضيلات':'Preferences','المساعدة':'Help','النسخ الاحتياطي':'Backup','استعادة':'Restore','صحة النظام':'System health','فحص الربط':'Connection check','حالة الاتصال':'Connection status','تحديث مباشر':'Live update',
