...
for (const [name, html] of [['desktop', desktop], ['mobile', mobile]]) {
  check(html.includes('./modules/store/discovery.js?v=2.3.0'), `${name}-discovery-version`);
  check(html.indexOf('./modules/core/platform.js?v=2.3.0') < html.indexOf('./modules/store/discovery.js?v=2.3.0'), `${name}-load-order`);
