...
`options.css` is retained only as a compatibility stub and is no longer loaded. New component rules must go into the owning file; do not append cross-platform emergency overrides.
