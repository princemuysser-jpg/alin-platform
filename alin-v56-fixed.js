...
document.addEventListener('DOMContentLoaded',()=>{
  document.querySelectorAll('.alin100-bottom button').forEach(btn=>btn.addEventListener('click',()=>{
    document.querySelectorAll('.alin100-bottom button').forEach(x=>x.classList.remove('active'));
