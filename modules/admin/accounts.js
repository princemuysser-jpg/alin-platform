...
(function(){AlinAdminModules.register('accounts',root=>{if(!root)return;root.classList.add('admin-accounts-module');const h=root.querySelector('h2');if(h&&!root.querySelector('.admin-module-note'))h.insertAdjacentHTML('afterend','<div class="admin-module-note">إدارة المدرسين والمكتبات والمندوبين وحالات الحسابات من هذا القسم.</div>')})})();
