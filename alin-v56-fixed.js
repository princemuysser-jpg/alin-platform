...
(function(){
  ...
  function injectAdminFeatures(){
    ...
    if(!adminStats.querySelector('.alin-v85-adminfeatures'))adminStats.insertAdjacentHTML('afterend','<div class="alin-v85-adminfeatures"><button onclick="alinV85Control()">⚙ مركز ميزات المتجر</button><button onclick="alinV85Reports()">📊 التقارير</button><button onclick="renderCouponsAdmin()">🎟 الكوبونات</button></div>');
  }
  ...
  setInterval(()=>{injectAdminFeatures();alinV85Badges()},3000);
