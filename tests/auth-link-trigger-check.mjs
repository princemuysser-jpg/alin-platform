...
const sql=fs.readFileSync('RUN_ON_SUPABASE_v2_1_3_COMPLETE.sql','utf8');
const check=fs.readFileSync('CHECK_SUPABASE_READINESS_v2_1_3.sql','utf8');
const required=[
...
if(!check.includes("ALIN v2.1.3 readiness check passed."))throw new Error('readiness version/result missing');
