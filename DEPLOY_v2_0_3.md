...
3. انشر Edge Functions الموجودة داخل `supabase/functions`.
4. شغّل `CHECK_SUPABASE_READINESS_v2_0_3.sql`.
5. إذا نجح الفحص، ارفع ملفات الموقع.
6. امسح Cache الموقع أو أعد تحميله؛ الإصدار الجديد يستخدم cache-buster رقم `2.0.3`.
