...
for(const htmlName of ['store-desktop.html','store-mobile.html']){
  ...
  check(source.includes('./modules/core/i18n-en.js?v=2.4.2')&&source.includes('./modules/core/i18n-ku.js?v=2.4.2')&&source.includes('./modules/core/i18n.js?v=2.4.2'),`${htmlName}-scripts`);
  check(source.includes('./styles/alin-i18n.css?v=2.4.2'),`${htmlName}-style`);
