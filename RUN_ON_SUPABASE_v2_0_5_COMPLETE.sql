-- منصة آلين v2.0.5 — تحديث Supabase المعتمد والقابل لإعادة التشغيل
...
-- ملاحظة: الأوامر التالية مضافة في v2.0.5 لتنظيف كلمات المرور القديمة وتأمين المندوبين.
...
-- ============================================================
-- v2.0.5: إنشاء الطلبات من الخادم بدلاً من الكتابة المباشرة
-- ============================================================
begin;
...
-- ============================================================
-- v2.0.5: حماية الجداول الحساسة وسياسات RLS الموحدة
-- ============================================================
begin;
